...
{
    /// <summary>
    /// A dependence of LongPollingTransport, copied here because the original is not made public.
    /// </summary>
    ...
    /// <summary>
    /// Copied from LongPollingTransport for adding the customize(HttpWebRequest) method 
    /// </summary>
    // TODO: make internal, not public
    public class CustomizableLongPollingTransport : HttpClientTransport
    {
        private List<TransportExchange> _exchanges = new List<TransportExchange>();
        //private bool _aborted;
        private bool _appendMessageType;

        public CustomizableLongPollingTransport(IDictionary<String, Object> options)
        ...
        public virtual void customize(HttpWebRequest request)
        {
        }
        ...
        {
            private CustomizableLongPollingTransport parent;
            ...
            public TransportExchange(CustomizableLongPollingTransport _parent, ITransportListener _listener, IList<IMutableMessage> _messages,
